...
export function Footer() {
  return (
    <footer className="fixed bottom-0 inset-x-0 flex flex-col md:flex-row-reverse sm:justify-center md:justify-between items-center gap-4 p-4 bg-gradient-to-b from-zinc-100 to-zinc-400 px-12 md:px-24">
